...
BreakCode = {"Loop": -1, "Xmin": 0, "Ymin": 1, "Zmin": 2, "Rmin": 3, "Dist2Path": 4, "Xmax": 5, "Ymax": 6,
             "Zmax": 7, "Rmax": 8, "MaxPath": 9, "MaxTime": 10, "Decay": -2}
BreakIndex = {-1: "Loop", 0: "Xmin", 1: "Ymin", 2: "Zmin", 3: "Rmin", 4: "Dist2Path", 5: "Xmax",
                             6: "Ymax", 7: "Zmax", 8: "Rmax", 9: "MaxPath", 10: "MaxTime", -2: "Decay"}
BreakDef = np.array([0, 0, 0, 0, 0, np.inf, np.inf, np.inf, np.inf, np.inf, np.inf])
BreakMetric = np.s_[:-1]
