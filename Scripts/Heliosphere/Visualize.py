...
for _ in range(2):
    bn = ParkerUniform(x=1/np.sqrt(2), y=1/np.sqrt(2), z=0, use_noise=True, log_kmin=1, log_kmax=6, noise_num=512, use_slab=False, use_reg=False)
    ...
    #           length=0.02, normalize=True, color="r")
