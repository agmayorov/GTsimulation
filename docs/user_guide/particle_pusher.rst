...
The particle pusher algorithms are implemented through a dedicated **Pusher Module**.
...
The specific classes that implement these pusher algorithms can be found within the :py:mod:`gtsimulation.pusher`
